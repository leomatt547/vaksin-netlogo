turtles-own
  [ sick?                ;; if true, the turtle is infectious
    vaccine?             ;; if true, the probability of infectious is lower
...
globals
  [ %infected            ;; what % of the population is infectious
    ...
    jumlah-vaksin        ;; number of people that get vaccinated
...
to setup-turtles
  ...
  set jumlah-vaksin (initial-vaccine * 0.01 * number-people)
  ask n-of jumlah-vaksin turtles
    [ get-vaccine ]
...
to get-vaccine ;; turtle procedure
  set sick? false
  set vaccine? true
...
to update-display
  ask turtles
    [ if shape != turtle-shape [ set shape turtle-shape ]
      set color ifelse-value vaccine? [ green ] [ ifelse-value sick? [ red ] [ ifelse-value immune? [grey][yellow]]]]
end
...
to infect ;; turtle procedure
  ask other turtles-here with [ not sick? and not immune? and not vaccine?]
...
"not-vaccine" 1.0 0 -1184463 true "" "plot count turtles with [ not sick? and not immune? and not vaccine?]"
"vaccine" 1.0 0 -13840069 true "" "plot count turtles with [ vaccine?]"
"total" 1.0 0 -14070903 true "" "plot count turtles"
